...
export const societyModeFormConfig: IFormInputConfig[] = [
...

  {
    ...
    name: 'defaultName',
    label: 'societyMode.form.password.label',
    isRequired: true,
    placeholder: 'societyMode.form.password.placeholder',
    defaultValue: null,
    isDisabled: false,
    widthClass: 'w-full',
    inputWithIcon: true,
    ...
    showConfirm: true,
    validation: [
      { function: Validators.required, errorMessage: 'societyMode.form.password.errors.required' },
    ],
    enableLabelClick: true,
    stopPaste: true,
  },
